    ...
    public class Data
    {
        ...
        public static List<Manifestacija> ReadFest(string path)
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                ...
                Manifestacija p = new Manifestacija(tokens[0], tokens[1], (TypeManifestacije)Enum.Parse(typeof(TypeManifestacije), tokens[2]), int.Parse(tokens[3]), tokens[4], Double.Parse(tokens[5]), mjesto, tokens[9]);
